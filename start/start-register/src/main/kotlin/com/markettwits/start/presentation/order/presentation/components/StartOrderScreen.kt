package com.markettwits.start.presentation.order.presentation.components
...
import com.markettwits.start.presentation.order.presentation.components.distance_info.StartDistanceInfoBox
import com.markettwits.start.presentation.order.presentation.components.members.StartMembers
import com.markettwits.start.presentation.order.presentation.components.order.OrderComponentBox
import com.markettwits.start.presentation.order.presentation.components.payment.PaymentTypeBox
import com.markettwits.start.presentation.order.presentation.components.promo.PromoBox
import com.markettwits.start.presentation.order.presentation.store.OrderStore


@Composable
fun StartOrderScreen(component: com.markettwits.start.presentation.order.presentation.component.OrderComponentComponent) {

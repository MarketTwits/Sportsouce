 ...
 * of the calendar. For example you can get the list of currently displayed
 * months.
 *
...
class CalendarLayoutInfo(info: LazyListLayoutInfo, private val month: (Int) -> CalendarMonth) :
    ...
    /**
     * The list of [CalendarItemInfo] representing all the currently visible
     * months.
     */
...
/**
 * Contains useful information about an individual [CalendarMonth] on the
 * calendar.
 *

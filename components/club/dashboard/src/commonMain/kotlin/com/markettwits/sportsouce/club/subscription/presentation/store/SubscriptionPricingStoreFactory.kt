...
class SubscriptionPricingStoreFactory(
    ...
    private val clubRepository: com.markettwits.sportsouce.club.common.domain.ClubRepository,
) {
                ...
                is SubscriptionPricingStore.Intent.OnClickSubscribe -> {
                    publish(
                        SubscriptionPricingStore.Label.Registration(
                            com.markettwits.sportsouce.club.registration.domain.RegistrationType.Subscription(

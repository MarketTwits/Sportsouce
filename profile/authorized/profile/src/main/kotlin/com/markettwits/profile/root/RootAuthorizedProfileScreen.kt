...
import com.markettwits.profile.authorized.presentation.components.NewAuthorizedProfileScreen
...
fun RootAuthorizedProfileScreen(component: RootAuthorizedProfileComponent) {
    ...
    com.arkivanov.decompose.extensions.compose.stack.Children(
        ...
        when (val child = it.instance) {
            is RootAuthorizedProfileComponent.Child.AuthProfile -> NewAuthorizedProfileScreen(
                component = child.component
            )

            is RootAuthorizedProfileComponent.Child.EditProfile -> EditProfileScreen(component = child.component)

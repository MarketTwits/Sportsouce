...
object SportSouceColor{
    ...
    val SportSouceLighBlueParent = Color(229, 244, 254)
    ...
    val DarkSecondary = Color(23, 23, 23)
    val DarkSecondaryNew = Color(18, 18, 18)
    val DarkSecondaryNew2 = Color(29, 32, 37)
    val DarkSecondaryContainer = Color(61, 61, 61)

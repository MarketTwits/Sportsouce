...
/**
 * Returns the first visible month in a paged calendar **after** scrolling
 * stops.
 *
...
/**
 * Find first visible week in a paged week calendar **after** scrolling
 * stops.
 */
@Composable
...
/**
 * Find the first month on the calendar visible up to the given
 * [viewportPercent] size.
 *
 * @see [rememberFirstCompletelyVisibleMonth]
 * @see [rememberFirstVisibleMonthAfterScroll]
 */

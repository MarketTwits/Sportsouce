...
interface MembersFilter {
    fun filterByKeyWordTeam(value: String, initialValue : List<StartMembersUi.Team>) : List<StartMembersUi>
    fun filterByKeyWordSingle(value: String, initialValue : List<StartMembersUi.Single>) : List<StartMembersUi>

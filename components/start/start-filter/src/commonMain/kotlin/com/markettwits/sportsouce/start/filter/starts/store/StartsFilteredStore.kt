package com.markettwits.sportsouce.start.filter.starts.store
...
import com.markettwits.sportsouce.start.filter.starts.store.StartsFilteredStore.Intent
import com.markettwits.sportsouce.start.filter.starts.store.StartsFilteredStore.Label
import com.markettwits.sportsouce.start.filter.starts.store.StartsFilteredStore.State
    ...
    private object ReducerImpl : Reducer<State, Msg> {
        override fun State.reduce(msg: Msg): State =
            when (msg) {
                ...
                is Msg.InfoLoaded -> copy(isLoading = false, starts = msg.starts)

...
interface ShopCreateOrderStore : Store<Intent, State, Label> {
    ...
    sealed interface Message{
        ...
        data class UpdateShopRecipientState(val shopRecipientState: State.ShopRecipientState) :
            Message
        data class UpdateCreateOrderStatus(val shopCreateOrderState: State.ShopCreateOrderButtonState) :
            Message

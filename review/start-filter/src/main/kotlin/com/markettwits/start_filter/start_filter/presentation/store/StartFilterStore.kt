...
interface StartFilterStore : Store<StartFilterStore.Intent, StartFilterStore.State, StartFilterStore.Label> {

    sealed interface Intent {
        data class OnItemSelected(val startFilter: String, val index : Int,val singleChoice : Boolean = true) : Intent
